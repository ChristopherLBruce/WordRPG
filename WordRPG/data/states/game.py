...
from WordRPG import const
from ...engine.time import Game_Time
from ...engine.common import Point, Table
from ...engine.gui.screen import Screen
from ...engine.state_machine import State
from ...engine.game_map import Game_Map
...
class Game(State):
    ...
    def _init_maps(self):
        ...
        maps = {k:Game_Map(**v, game_time=self.game_time) for k, v in const.MAPS_DATA.items()}
